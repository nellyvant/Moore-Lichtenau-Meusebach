...
mean_rmse # Taupunkt: weicht ca. 0,81 % von den echten Werten ab
...
mean_rmse # Taupunkt: weicht ca. 0,097 C° von den echten Werten ab
sd_rmse # SD: 0,002 -> bei 5 Wiederholungen fast identische Ergebnisse = stabiles Modell, keine Zufallseffekte 
...
mean_rmse # Temperatur: weicht ca. 0,91 °C von den echten Werten ab
sd_rmse # SD: 0,016 -> bei 5 Wiederholungen sehr ähnliche identische Ergebnisse = stabiles Modell, keine Zufallseffekte
nrmse # NRMSE: 0,096 -> Fehler ist relativ klein im Verhältnis zur natürlichen Variabilität
```
...
mean_rmse # Taupunkt: weicht ca. 0,72 % von den echten Werten ab
